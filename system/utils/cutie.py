...
def select(
    ...
    Returns:
        ...
        :param deselected_prefix:
        :param caption_indices:
        :param options:
        :param caption_prefix:
        :param confirm_on_select:
        :param selected_index:
        :param pre_print: need
    """
    if is_print_logo:
        print_logo()
    if pre_print:
